    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home') }}" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="{{asset('img/logo2.png')}}" style="height: 52px; width: 100px;margin: 0px;"></a>
            </div>
