            ...
            <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img class="img-responsive" style="height: 300px" src="{{ asset('img/logo2.png') }}">
                    </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3">
            <a href="{{ route('Productshow', $product->id) }}">
                <div class="book-block">
                    ...
                    <img style="height: 300px; width:200px" class="book block-center img-responsive" src="{{ asset('storage/' . $product->image) }}">
                    <hr>
                    {{ $product->name }} <br>
                    $ {{ $product->price }} &nbsp
                </div>
